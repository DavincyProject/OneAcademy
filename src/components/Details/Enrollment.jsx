  ...
  return (
    <div key={id}>
      ...
      <button
        ...
        onClick={() => document.getElementById("enrollment").showModal()}
      >
        <span className="flex justify-center items-center">Mulai Kelas</span>
      </button>
      <dialog id="enrollment" className="modal">
        <div className="modal-box">
          ...
          <div className="text-center">
            <h3 className="font-bold text-2xl text-check-100">Onboarding...</h3>
          </div>
          ...
          <div className="flex flex-col items-center justify-center mt-5">
            ...
            <div className="text-center mt-4">
              ...
              <ul>
                <li>Mempunyai akun Figma atau Install Adobe XD</li>
                <li>Menggunakan internet minimal kecepatan 2Mbps</li>
          ...
          <div className="modal-action flex justify-center">
            <form method="dialog">
              <button
                alt="close button"
                className="font-bold text-base mt-3 w-[250px] lg:w-[320px] h-[48px] bg-darkblue text-white rounded-[25px]"
              >
                Ikuti Kelas
              </button>
            </form>
