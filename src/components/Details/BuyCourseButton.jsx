...
const BuyCourseButton = ({ id }) => {
  ...
  return (
    <div key={id}>
      ...
      <button
        className="h-[34px] w-[200px] md:w-[269px] bg-darkblue mt-3 text-white rounded-[25px]"
      ...
      <dialog id="buy_class" className="modal">
        <div className="modal-box">
          ...
          <div className="text-center">
            <h3 className="font-bold text-[24px]">Selangkah lagi menuju</h3>
            ...
            >
              ...
              <div className="flex w-full flex-col mt-1.5 px-2.5">
                ...
                <div className="self-stretch text-black text-xs font-bold leading-4">
                  ...
                  <span className=" text-black">{prevCard?.instructor}</span>
                </div>
                ...
                <div className="badge badge-blue p-3 mt-2">
                  <div className="flex gap-1 items-center font-Poppins font-bold">
                    ...
                    <p className="font-bold text-xs">
                      <span className="mr-2">{prevCard.courseType}</span>{" "}
                      {prevCard.price !== 0 && (
                        <>{formatPrice(prevCard.price)}</>
                      )}
                    </p>
                  </div>
                </div>
