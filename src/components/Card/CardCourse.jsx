                                ...
                                {categories.map((category) => (
                                    <div key={category.id}>
                                        <div
                                            ...
                                            onClick={() =>
                                                handleBadgeClick(category.name)
                                            }
                                        >
                                            {category.name}
                                        </div>
                    ...
                    {course
                        ...
                        .map((data) => (
                            <Link
                                to={`/details/${data.id}`}
                                key={data.id}
                                className="shadow-md bg-white flex flex-col flex-grow sm:flex-none items-stretch pb-2.5 rounded-2xl max-w-[323px] max-h-[190px]"
                            >
                                <img
                                    loading="lazy"
