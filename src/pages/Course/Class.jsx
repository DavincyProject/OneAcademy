        ...
        <div className="flex flex-grow justify-between items-start gap-2 md:mt-[30px] w-full lg:max-w-[1000px]">
          ...
          <div className="flex flex-col flex-grow">
            ...
            <div className="flex items-center justify-center my-5">
              <div className="join">
                <button className="join-item btn btn-blue">«</button>
                <button className="join-item btn btn-blue">1</button>
                <button className="join-item btn btn-active">2</button>
                <button className="join-item btn btn-blue">3</button>
                <button className="join-item btn btn-blue">4</button>
                <button className="join-item btn btn-blue">»</button>
              </div>
            </div>
          </div>
